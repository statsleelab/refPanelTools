...
// simulate_af1_z2
void simulate_af1_z2(int chr_num, std::vector<std::string> pop_vec, std::vector<int> num_sim_vec, std::string index_data_file, std::string reference_data_file, std::string reference_pop_desc_file, std::string ref_out_file);
RcppExport SEXP _refPanelTools_simulate_af1_z2(SEXP chr_numSEXP, SEXP pop_vecSEXP, SEXP num_sim_vecSEXP, SEXP index_data_fileSEXP, SEXP reference_data_fileSEXP, SEXP reference_pop_desc_fileSEXP, SEXP ref_out_fileSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< int >::type chr_num(chr_numSEXP);
    Rcpp::traits::input_parameter< std::vector<std::string> >::type pop_vec(pop_vecSEXP);
    ...
    Rcpp::traits::input_parameter< std::string >::type reference_pop_desc_file(reference_pop_desc_fileSEXP);
    Rcpp::traits::input_parameter< std::string >::type ref_out_file(ref_out_fileSEXP);
    simulate_af1_z2(chr_num, pop_vec, num_sim_vec, index_data_file, reference_data_file, reference_pop_desc_file, ref_out_file);
    return R_NilValue;
END_RCPP
}
// extract_reg_data
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_refPanelTools_simulate_af1_z2", (DL_FUNC) &_refPanelTools_simulate_af1_z2, 7},
